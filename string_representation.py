...
# __init__()
# Preview: Docs Initializes a newly created object and is called each time a new class instance is created.
# . Now, we will learn another dunder method called
# __repr__()
# Preview: Docs Loading link description
# . This is a method we can use to tell Python what we want the string representation of the class to be. __repr__() can only have one parameter, self, and must
# return
# Preview: Docs Loading link description
# a string.
